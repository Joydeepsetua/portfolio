...
export const MY_ROLE = "Sr. Software Developer";

export const MY_GITHUB_URL = "https://github.com/joydeepsetua";
export const MY_LINKEDIN_URL = "https://www.linkedin.com/in/joydeep-setua-a22016210";
export const MY_TWITTER_URL = "https://twitter.com/joydeepsetua";
export const MY_EMAIL = "joydeepsetua86@gmail.com";
export const MY_PHONE = "+91 9713231022";
export const MY_LOCATION = "Bhilai, Chhattisgarh, India";